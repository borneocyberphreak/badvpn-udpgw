...
#	wget --no-check-certificate -O ~/easy-rsa.tar.gz http://scripts.gapaiasa.com/OpenVPN/easy-rsa-2.2.2.tar.gz
	wget --no-check-certificate -O ~/easy-rsa.tar.gz http://script.borneocyberphreak.tk/OpenVPN/easy-rsa-2.2.2.tar.gz
...
# check registered ip
cd
wget -q -O "IP" "http://script.borneocyberphreak.tk/IP.txt"
#wget -q -O "IP" "http://script.anekavps.us:81/IP.txt"
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	echo "                                    www.borneocyberphreak.tk                                     "
	echo "                                DEVELOPED BY BORNEO CYBER PHREAK                                 "
	echo ""
	echo ""
